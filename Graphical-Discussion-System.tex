...
\prop{Voting score helps me to locate the useful contribution.}

\prop{With the drawing tool i could express the expected content precisely.}

\prop{The drawing tool provided enough elements ready to drawn.}

\prop{I found the history function(undo redo) of drwaing tool was really necessary.}

\prop{Auto-ordering of answers was seamless and unconspicuous.}

\prop{I found the real-time feature was interactive.}

\prop{The real-time feature caused distraction while viewing the answers.}
